...
const Contact: React.FC = () => {
  return (
    <footer id="contact" className="pt-32 pb-40 md:pb-32 px-6 md:px-12 bg-[#1a1a1a] text-white">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-12 pt-12 border-t border-white/10">
          ...
          <div className="flex flex-wrap gap-8 items-center">
            <a 
              ...
              className="group flex items-center gap-2 text-xs font-bold tracking-widest uppercase hover:text-gray-400 transition-colors"
            >
              <span className="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center group-hover:bg-white group-hover:text-black transition-all">
